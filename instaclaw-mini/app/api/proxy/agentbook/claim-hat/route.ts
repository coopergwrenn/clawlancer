...
/**
 * Mini app proxy → instaclaw.io for the AgentBook hat-claim recording.
 * No body — the upstream endpoint records hat_claimed_at on the user
...
export async function POST() {
  try {
    ...
    const res = await fetch(`${baseUrl}/api/agentbook/claim-hat`, {
      method: "POST",
      headers: {
