...
import { Lock, Loader2, LayoutGrid, BarChart3, DollarSign, Mail, Server, Award, Package } from "lucide-react";
...
const NAV_TABS = [
  ...
  { href: "/hq/invites", label: "Invites", icon: Mail },
  { href: "/hq/fleet-upgrade", label: "Fleet", icon: Server },
