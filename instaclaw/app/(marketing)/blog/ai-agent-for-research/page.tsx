    ...
    <>
      ...
      <article className="mx-auto max-w-2xl px-6 py-16 sm:py-24" style={{ color: "#333334" }}>
        ...
        <section className="mb-12">
          ...
          <p className="text-sm leading-relaxed mb-4" style={{ color: "#6b6b6b" }}>
            InstaClaw handles these configurations automatically — you get an <a href="https://openclaw.ai" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-70" style={{ color: "#DC6743" }}>OpenClaw</a> agent with search, document analysis, and memory enabled by default. Plans start at $49.99/month and include all the tools you need for serious research work.
          </p>
          <p className="text-sm leading-relaxed mb-4" style={{ color: "#6b6b6b" }}>
        ...
        <section className="mb-12">
          ...
          <p className="text-sm leading-relaxed mb-4" style={{ color: "#6b6b6b" }}>
            Self-hosting an <a href="https://github.com/openclaw" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-70" style={{ color: "#DC6743" }}>OpenClaw agent</a> gives you complete control but requires managing servers, handling updates, configuring tools, and troubleshooting issues. You also need to set up and maintain integrations with search APIs, document processing libraries, and output formatting tools.
          </p>
          <p className="text-sm leading-relaxed mb-4" style={{ color: "#6b6b6b" }}>
