    ...
    <>
      ...
      <article className="mx-auto max-w-2xl px-6 py-16 sm:py-24" style={{ color: "#333334" }}>
        ...
        <section className="mb-12">
          ...
          <p className="text-sm leading-relaxed mb-4" style={{ color: "#6b6b6b" }}>
            <strong style={{ color: "#333334" }}>Model flexibility.</strong> Being locked into a single LLM provider is increasingly seen as a dealbreaker. The best platforms let you swap between OpenAI, <a href="https://anthropic.com" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-70" style={{ color: "#DC6743" }}>Anthropic</a>, local models, or custom fine-tuned versions without major refactoring.
          </p>
          <p className="text-sm leading-relaxed mb-4" style={{ color: "#6b6b6b" }}>
