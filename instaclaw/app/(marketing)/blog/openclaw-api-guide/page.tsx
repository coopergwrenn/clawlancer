      ...
      <article className="mx-auto max-w-2xl px-6 py-16 sm:py-24" style={{ color: "#333334" }}>
        ...
        <section className="mb-12">
          <p className="text-sm leading-relaxed mb-4" style={{ color: "#6b6b6b" }}>
            The <strong style={{ color: "#333334" }}>OpenClaw API</strong> is the programmatic interface that lets developers build applications, integrations, and automations on top of the <a href="https://openclaw.ai" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-70" style={{ color: "#DC6743" }}>OpenClaw</a> framework. Whether you&apos;re extending your AI agent with custom capabilities, building a third-party tool that interacts with OpenClaw, or creating automated workflows that leverage agent intelligence, the API provides the foundation you need.
          </p>
          <p className="text-sm leading-relaxed mb-4" style={{ color: "#6b6b6b" }}>
        ...
        <section className="mb-12">
          ...
          <p className="text-sm leading-relaxed mb-4" style={{ color: "#6b6b6b" }}>
            <strong style={{ color: "#333334" }}>Skills Endpoint</strong> — Managing agent capabilities is handled through <code style={{ backgroundColor: "#f5f5f5", padding: "2px 6px", borderRadius: "3px", fontFamily: "monospace" }}>/v1/skills</code>. You can query available skills, install new skills on an agent, update skill configurations, and remove skills that are no longer needed. This endpoint integrates with the broader <Link href="/blog/openclaw-skills-guide" className="underline" style={{ color: "#DC6743" }}>skills ecosystem</Link> — built on the <a href="https://modelcontextprotocol.io" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-70" style={{ color: "#DC6743" }}>Model Context Protocol</a> — to keep your agents equipped with the right tools.
          </p>
          <p className="text-sm leading-relaxed mb-4" style={{ color: "#6b6b6b" }}>
...
print(f'Skill installed: {result["message"]}')`}
        ...
        <section className="mb-12">
          ...
          <p className="text-sm leading-relaxed mb-4" style={{ color: "#6b6b6b" }}>
            The OpenClaw community maintains <a href="https://github.com/openclaw" target="_blank" rel="noopener noreferrer" className="underline hover:opacity-70" style={{ color: "#DC6743" }}>example repositories</a> for common integration patterns including Slack bots, GitHub Actions workflows, and data pipeline integrations. These provide tested starting points for your own projects. You can find links to these resources in the developer documentation along with tutorials covering specific use cases.
          </p>
          <p className="text-sm leading-relaxed mb-4" style={{ color: "#6b6b6b" }}>
