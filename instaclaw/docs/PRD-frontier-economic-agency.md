...
- **Hardening (this session):** spend kill switch (C21), write-once latency+failure capture (C22), atomic reserve RPC / P1-4 (C23), spend-health alerting cron / P2-6 (C24), standing-truncation flag / P2-8 (C26). Frontier test suite: **469 passed / 0 failed across the 13 `_test-frontier-*.ts` suites.**
