  ...
  try {
    ...
    try {
      ...
      const dispatchScripts = [
        ...
        'dispatch-remote-screenshot.sh', 'dispatch-remote-click.sh', 'dispatch-remote-type.sh', 'dispatch-remote-press.sh', 'dispatch-remote-scroll.sh', 'dispatch-remote-status.sh', 'dispatch-remote-batch.sh', 'dispatch-remote-drag.sh', 'dispatch-remote-windows.sh', 'dispatch-windows.sh', 'gateway-watchdog.sh', 'dispatch-connection-info.sh',
      ];
