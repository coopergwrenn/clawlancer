...
INSERT INTO instaclaw_dependencies (name, description, category, check_type, check_target, repo_url, our_version, update_impact, notes) VALUES
  ...
  ('NextAuth.js', 'Authentication framework (Google OAuth + sessions)', 'core', 'npm', 'next-auth', 'https://github.com/nextauthjs/next-auth', '^5.0.0-beta.30', 'high', 'Pre-release beta. Major upgrades need full auth flow testing.'),
  ...
  ('py-clob-client', 'Python SDK for Polymarket CLOB trading', 'skill', 'pypi', 'py-clob-client', 'https://github.com/polymarket/clob-client', NULL, 'high', 'Used in 6+ prediction market scripts. No version pinning on VMs.'),
  ('web3.py', 'Python Ethereum interaction library', 'skill', 'pypi', 'web3', 'https://github.com/ethereum/web3.py', NULL, 'high', 'No version pinning. Major versions have breaking contract interaction APIs.'),
  ('eth-account', 'Python Ethereum wallet/signing library', 'skill', 'pypi', 'eth-account', 'https://github.com/ethereum/eth-account', NULL, 'high', 'No version pinning. Critical for wallet operations.'),
  ('solders', 'Rust-based Solana library for Python', 'skill', 'pypi', 'solders', 'https://github.com/kevinheavey/solders', NULL, 'high', 'No version pinning. Solana transaction format changes could break trades.'),
  ('cryptography', 'Python cryptographic operations for API signing', 'skill', 'pypi', 'cryptography', 'https://github.com/pyca/cryptography', NULL, 'high', 'No version pinning. Used by kalshi-setup for credential signing.'),
  ('httpx', 'Async HTTP client for Python skills', 'skill', 'pypi', 'httpx', 'https://github.com/encode/httpx', NULL, 'medium', 'No version pinning. Used in solana-defi for RPC calls.'),
  ('websockets', 'WebSocket client for real-time market data', 'skill', 'pypi', 'websockets', 'https://github.com/python-websockets/websockets', NULL, 'medium', 'No version pinning. Used by polymarket and prediction-markets skills.')
